...
fuguectl incident recovery /tmp/failure.log --source-ref ~/.claude/tasks/TASK-2026-06-29-023.md --json # failed trace -> bounded containment/repair/validation/learning packet
