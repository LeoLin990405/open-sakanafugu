...
Research basis: 1-2 rounds capture most reachable improvement, a hard cap prevents oscillation, and generation != review keeps the verifier independent. The memory step follows [Reflexion](https://arxiv.org/abs/2303.11366), [Self-Refine](https://arxiv.org/abs/2303.17651), [Agent Workflow Memory](https://arxiv.org/abs/2409.07429), and [AgentHER](https://arxiv.org/abs/2603.21357): useful traces should become reusable verbal feedback, but failed traces must be explicitly relabeled before replay. FuguNano's `experience learn --allow-failure --lesson ... --failure-cause <cause>` writes that relabel; `experience recall --failure-cause <cause>` filters by the failure mode before query ranking to reduce misaligned replay. Harness evolution follows [Self-Harness](https://arxiv.org/abs/2606.09498) and related retrospective harness optimization work such as [RHO](https://arxiv.org/abs/2606.05922).
sources: [LLM Verification Loops](https://timjwilliams.medium.com/llm-verification-loops-best-practices-and-patterns-07541c854fd8) · [Loop Engineering 2026](https://shaam.blog/articles/loop-engineering-ai-agents) · [Reflexion](https://arxiv.org/abs/2303.11366) · [Self-Refine](https://arxiv.org/abs/2303.17651) · [Agent Workflow Memory](https://arxiv.org/abs/2409.07429) · [AgentHER](https://arxiv.org/abs/2603.21357) · [MemRL](https://arxiv.org/abs/2601.03192) · [Self-Harness](https://arxiv.org/abs/2606.09498).
